...
public class DiscriminativityPatternMapper extends AbstractPatternMapper
{
					...
					throws IOException
	{
		...
		final String [] positiveRecord = readRecord(fs, input1, offset1).split(Config.SepItems);
		final String [] negativeRecord = readRecord(fs, input2, offset2).split(Config.SepItems);
