...
public class SquaredFreqSamplingMapper extends AbstractPatternMapper
{
					...
					InterruptedException
	{
		...
		String [] record1 = readRecord(fs, inputfilepath, offset1).split(PARAMETERS.SeparatorItem);
		String [] record2 = readRecord(fs, inputfilepath, offset2).split(PARAMETERS.SeparatorItem);
