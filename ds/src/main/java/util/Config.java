...
public class Config
{
	...
	public static final String MIN_PRECISION = "dps.min.precision";
	public static final String MAX_PRECISION = "dps.max.precision";
...
//	public static final String RIGHT_BUFFER_LINES = "dps.right.buffer.lines";
	...
	public static final int DEFAULT_MAX_RECORD_LENGTH = 250; // adjustable
...
//	public static final int DEFAULT_RIGHT_BUFFER_LINES = 1000;	// number of lines that a mapper will read once
